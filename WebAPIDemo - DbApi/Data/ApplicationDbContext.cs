    ...
    public class ApplicationDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Shirt>().HasData(
                ...
                new Shirt { ShirtId = 3, Brand = "Your Brand", Color = "Red", Gender = "Women", Price = 28, Size = 8 },
                new Shirt { ShirtId = 4, Brand = "Your Brand", Color = "Yellow", Gender = "Women", Price = 30, Size = 10 }
            );   
        }
    }
}
